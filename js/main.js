$(document).ready(function() {
    ...
    if ($('#nav-menu-container').length) {
        ...
        $('body').prepend('<a href="tel:+919075576310" id="mobile-call-btn" aria-label="Call Now"><i class="fa fa-phone"></i><span>Call Now</span></a>');
        ...
        $(document).on('click', '#mobile-nav-toggle', function(e) {
            ...
            var container = $("#mobile-nav, #mobile-nav-toggle, #mobile-call-btn");
    ...
    } else if ($("#mobile-nav, #mobile-nav-toggle, #mobile-call-btn").length) {
        $("#mobile-nav, #mobile-nav-toggle, #mobile-call-btn").hide();
    }
